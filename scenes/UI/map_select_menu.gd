...
func _on_start_game_pressed():
	if map1_selected:
		get_tree().change_scene_to_file("res://scenes/environment/Map1.tscn")
	elif map2_selected:
		get_tree().change_scene_to_file("res://scenes/environment/Map2.tscn")
	elif map3_selected:
		get_tree().change_scene_to_file("res://scenes/environment/Map3.tscn")
	else:
		return null
